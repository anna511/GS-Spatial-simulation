...
##Simulation of data code originally from Jean-Luc Jannink ##December, 2015###
##Ani A. Elias ## May, 2016##
...
#assuming that range is on x axis and column on y axix as field coordinates; so for AR1, Range is the row and column is the column
...
#phi is the true autocorrelation value to be used for simulating data - a vector of phi values 
      #seq(0.5,max(distMat),12)  <- c(0.5 12.5 24.5 36.5 48.5 60.5)
...
geno_spatial_simulate_Gaus <- function(madII, phi, fracSpatial, heritability,plotSize, repl){
...
for(i in c(1:length(phi))){ 
  for(s in c(1:20)){
#create data1
  Gaus.h2.phi <- simGausFieldTrial(madII, phi=phi[i], plotSize=plotSize, fracSpatial=fracSpatial, heritability = heritability)
  data1 <- Gaus.h2.phi$fieldObs
...
#model2 - AR1 model
 ...
 ##blup and correlation##
  ...
  entryEff <- Gaus.h2.phi$entryEffects
 ...
 write.csv(entry.cor.melt, paste0("Gaus_fracSp_",fracSpatial,"-phi_",phi[i],"-rep_",repl,"-h2",heritability,"_entry_Effect_cor_melt.csv"))
 write.csv(entry.mse.melt, paste0("Gaus_fracSp_",fracSpatial,"-phi_",phi[i],"-rep_",repl,"-h2",heritability,"_entry_Effect_rmse_melt.csv"))
 write.csv(sp.cor.melt, paste0("Gaus_fracSp_",fracSpatial,"-phi_",phi[i],"-rep_",repl,"-h2",heritability,"_spatial_Effect_cor_melt.csv"))
 write.csv(sp.mse.melt, paste0("Gaus_fracSp_",fracSpatial,"-phi_",phi[i],"-rep_",repl,"-h2",heritability,"_spatial_Effect_rmse_melt.csv"))
 write.csv(resid.cor.melt, paste0("Gaus_fracSp_",fracSpatial,"-phi_",phi[i],"-rep_",repl,"-h2",heritability,"_residual_cor_melt.csv"))
 write.csv(resid.mse.melt, paste0("Gaus_fracSp_",fracSpatial,"-phi_",phi[i],"-rep_",repl,"-h2",heritability,"_residual_rmse_melt.csv"))
 write.csv(fra.Sp.melt, paste0("Gaus_fracSp_",fracSpatial,"-phi_",phi[i],"-rep_",repl,"-h2",heritability,"_fration_Spatial_melt.csv"))
 write.csv(herit.melt, paste0("Gaus_fracSp_",fracSpatial,"-phi_",phi[i],"-rep_",repl,"-h2",heritability,"_heritability_melt.csv"))
 write.csv(model.fail, paste0("Gaus_fracSp_",fracSpatial,"-phi_",phi[i],"-rep_",repl,"-h2",heritability,"_failure_melt.csv"))
  ...
  write.csv(entry.cor.2, paste0("Gaus_fracSp_",fracSpatial,"-rep_",repl,"-h2",heritability,"_entry_Effect_cor.csv"))
  write.csv(entry.mse.2, paste0("Gaus_fracSp_",fracSpatial,"-rep_",repl,"-h2",heritability,"_entry_Effect_error.csv"))
  write.csv(sp.cor.2, paste0("Gaus_fracSp_",fracSpatial,"-rep_",repl,"-h2",heritability,"_spatial_Effect_cor.csv"))
  write.csv(sp.mse.2, paste0("Gaus_fracSp_",fracSpatial,"-rep_",repl,"-h2",heritability,"_spatial_Effect_error.csv"))
  write.csv(resid.cor.2, paste0("Gaus_fracSp_",fracSpatial,"-rep_",repl,"-h2",heritability,"_residual_cor.csv"))
  write.csv(resid.mse.2, paste0("Gaus_fracSp_",fracSpatial,"-rep_",repl,"-h2",heritability,"_residual_error.csv"))
  write.csv(fra.Sp.2,  paste0("Gaus_fracSp_",fracSpatial,"-rep_",repl,"-h2",heritability,"_fraction_Spatial.csv"))
  write.csv(herit.2,  paste0("Gaus_fracSp_",fracSpatial,"-rep_",repl,"-h2",heritability,"_heritability.csv"))
  write.csv(model.fail.2,  paste0("Gaus_fracSp_",fracSpatial,"-rep_",repl,"-h2",heritability,"_failure.csv"))
